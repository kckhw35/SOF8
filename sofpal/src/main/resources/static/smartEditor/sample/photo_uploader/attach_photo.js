    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/product/register'; 	//upload URL
	...
	function onAjaxError (){
 	 ...
 	 */
 	function callFileUploader (p_id){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href='/product/register',	//샘플 URL입니다.
 	        sCallback : location.href='/product/productdetail?p_id='+p_id,	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
